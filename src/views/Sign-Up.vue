      ...
      <div class="bg-white rounded-md py-5 md:py-10 lg:py-16 px-7 md:px-16 w-full lg:w-5/12">
        ...
        <div class="flex md:text-lg text-base items-center mb-10 mt-2">
          ...
          <router-link to="/login">
            <button class="text-lg font-semibold text-dh-red-400 hover:text-dh-green-900 duration-300 cursor-pointer">Log
              In</button>
          </router-link>
        </div>
        <form>
          <div class="mb-7">
            <div class="flex items-center px-3.5 bg-[#F2F3F4] rounded-xl">
              <input name="name" placeholder="user Name" v-model="displayName" type="text"
                class="bg-[#F2F3F4] w-full px-2 py-3.5 outline-none" value="" />
            </div>
          </div>
          <div class="mb-7">
            <div class="flex items-center px-3.5 bg-[#F2F3F4] rounded-xl"><input name="email" placeholder="Email"
                v-model="email" type="text" class="bg-[#F2F3F4] w-full px-2 py-3.5 outline-none" value="" /></div>
          </div>
          <div class="mb-10">
            <div class="flex items-center px-3.5 bg-[#F2F3F4] rounded-xl">
